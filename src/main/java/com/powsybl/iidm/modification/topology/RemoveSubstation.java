...
public class RemoveSubstation extends AbstractNetworkModification {
    ...
    private static void notFoundSubstationReport(Reporter reporter, String substationId) {
    ...
    private static void removedSubstationReport(Reporter reporter, String substationId) {
        reporter.report(Report.builder()

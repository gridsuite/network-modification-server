...
public class NetworkModificationController {
    ...
    public ResponseEntity<CopyOrMoveModificationResult> copyOrMoveNetworkModification(@Parameter(description = "updated group UUID, where modifications are pasted") @PathVariable("groupUuid") UUID targetGroupUuid,

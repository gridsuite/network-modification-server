...
public class NetworkModificationController {
    ...
    public ResponseEntity<UpdateModificationGroupResult> updateModificationGroup(@Parameter(description = "updated group UUID, where modifications are pasted") @PathVariable("groupUuid") UUID targetGroupUuid,

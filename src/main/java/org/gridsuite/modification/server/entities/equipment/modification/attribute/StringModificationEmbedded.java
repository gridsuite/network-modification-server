...
@EqualsAndHashCode
@Getter
public class StringModificationEmbedded implements IAttributeModificationEmbeddable<String> {

    private String value;
    @Enumerated(EnumType.STRING)
    private OperationType opType;

    public StringModificationEmbedded(AttributeModification<String> attributeModification) {
    ...
    public StringModificationEmbedded() {
    }
}

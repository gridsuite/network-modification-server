...
public class HvdcLccDeletionEntity extends AbstractEquipmentDeletionEntity {
    ...
    @Override
    public AbstractEquipmentDeletionModel toDto() {
    ...
    private List<HvdcLccDeletionModel.ShuntCompensatorModel> toShuntCompensators(List<ShuntCompensatorSelectionEmbeddable> shuntCompensators) {
        return shuntCompensators != null ? shuntCompensators.stream()
            .map(s -> HvdcLccDeletionModel.ShuntCompensatorModel.builder()

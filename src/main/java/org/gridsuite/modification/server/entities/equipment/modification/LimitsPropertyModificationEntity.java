...
public class LimitsPropertyModificationEntity {
    ...
    public static LimitsPropertyModificationEntity fromLimitsPropertyModel(LimitsPropertyModel propertyInfos) {
        return new LimitsPropertyModificationEntity(null, propertyInfos.name(), propertyInfos.value());
    }

    public LimitsPropertyModel toLimitsPropertyModel() {

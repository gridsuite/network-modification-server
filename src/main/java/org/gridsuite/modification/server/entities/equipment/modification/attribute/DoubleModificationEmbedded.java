...
public class DoubleModificationEmbedded implements IAttributeModificationEmbeddable<Double> {
    ...
    public DoubleModificationEmbedded(org.gridsuite.modification.server.dto.AttributeModification<Double> attributeModification) {
    ...
    public DoubleModificationEmbedded() {
    }
}

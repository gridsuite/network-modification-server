 ...
 */
@Repository
public interface LoadModificationRepository extends JpaRepository<LoadModificationEntity, UUID>, EquipmentModificationRepository {
    @Modifying
    @Query(value = "DELETE FROM load_modification WHERE id IN ?1", nativeQuery = true)

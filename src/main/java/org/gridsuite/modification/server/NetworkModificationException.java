...
public class NetworkModificationException extends PowsyblException {
    public enum Type {
        ...
        THREE_WINDINGS_TRANSFORMER_NOT_FOUND(HttpStatus.NOT_FOUND),
        THREE_WINDINGS_TRANSFORMER_RATIO_TAP_CHANGER_NOT_FOUND(HttpStatus.NOT_FOUND),
        TWO_WINDINGS_TRANSFORMER_RATIO_TAP_CHANGER_NOT_FOUND(HttpStatus.NOT_FOUND);

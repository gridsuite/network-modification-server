...
public class NetworkModificationException extends PowsyblException {
    public enum Type {
        ...
        BUS_OR_BUSBAR_NOT_FOUND(HttpStatus.NOT_FOUND),
        ...
        NOT_A_BUS_OR_BUSBAR(HttpStatus.NOT_FOUND),
        ...
        DISCONNECTOR_ALREADY_EXISTS(HttpStatus.BAD_REQUEST),
        BREAKER_ALREADY_EXISTS(HttpStatus.BAD_REQUEST),

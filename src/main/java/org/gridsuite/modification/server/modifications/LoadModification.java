...
public class LoadModification extends AbstractModification {
    ...
    private void modifyLoad(Load load, LoadModificationInfos loadModificationInfos, Reporter subReporter) {
        ...
        ModificationUtils.getInstance().applyElementaryModifications(load::setP0, load::getP0, loadModificationInfos.getP0(), subReporter, "Constant active power");
        ModificationUtils.getInstance().applyElementaryModifications(load::setQ0, load::getQ0, loadModificationInfos.getQ0(), subReporter, "Constant reactive power");

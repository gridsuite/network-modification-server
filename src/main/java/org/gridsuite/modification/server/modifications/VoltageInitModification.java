...
public class VoltageInitModification extends AbstractModification {
    ...
    private static final String TRANSFORMERS_KEY = "TransformersModifications";
    private static final String TRANSFORMERS_NAME = "Transformers";
    ...
    private void applyGeneratorModification(Network network, Reporter subReporter) {
        ...
        for (final VoltageInitGeneratorModificationInfos m : voltageInitModificationInfos.getGenerators()) {
            ...
            if (generator == null) {
                generatorsReporter.report(Report.builder().withKey("generatorNotFound")
                ...
                modificationsCount++;
                generatorsReporter.report(Report.builder().withKey("generatorModification")
                ...
                if (m.getVoltageSetpoint() != null) {
                    ...
                    generatorsReporter.report(ModificationUtils.buildModificationReport(oldTargetV, m.getVoltageSetpoint(), VOLTAGE_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
                if (m.getReactivePowerSetpoint() != null) {
                    ...
                    generatorsReporter.report(ModificationUtils.buildModificationReport(oldTargetQ, m.getReactivePowerSetpoint(), REACTIVE_POWER_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
            }
        }
    ...
    private void applyTransformerModification(Network network, Reporter subReporter) {
        int modificationsCount = 0;
        Reporter transformersReporter = subReporter.createSubReporter(TRANSFORMERS_KEY, TRANSFORMERS_NAME);
        for (final VoltageInitTransformerModificationInfos t : voltageInitModificationInfos.getTransformers()) {
            ...
            if (t.getLegSide() != null) {
                ...
                if (threeWindingsTransformer == null) {
                    transformersReporter.report(Report.builder().withKey("3WindingsTransformerNotFound")
                    ...
                    transformersReporter.report(Report.builder().withKey("3WindingsTransformerRatioTapChangerNotFound")
                    ...
                    transformersReporter.report(Report.builder().withKey("3WindingsTransformerModification")
                    ...
                    transformersReporter.report(ModificationUtils.buildModificationReport(oldTapPosition, t.getRatioTapChangerPosition(), "Leg " + t.getLegSide().name() + " ratio tap changer position", 1, TypedValue.TRACE_SEVERITY));
                }
            } else {
                final TwoWindingsTransformer twoWindingsTransformer = network.getTwoWindingsTransformer(t.getTransformerId());
                if (twoWindingsTransformer == null) {
                    transformersReporter.report(Report.builder().withKey("2WindingsTransformerNotFound")
                        .withDefaultMessage("2 windings transformer with id=${id} not found")
                        .withValue("id", t.getTransformerId())
                        .withSeverity(TypedValue.WARN_SEVERITY).build());
                } else if (twoWindingsTransformer.getRatioTapChanger() == null) {
                    transformersReporter.report(Report.builder().withKey("2WindingsTransformerRatioTapChangerNotFound")
                        .withDefaultMessage("2 windings transformer with id=${id} : Ratio tap changer not found")
                        .withValue("id", t.getTransformerId())
                        .withSeverity(TypedValue.WARN_SEVERITY).build());
                } else {
                    transformersReporter.report(Report.builder().withKey("2WindingsTransformerModification")
                    ...
                    transformersReporter.report(ModificationUtils.buildModificationReport(oldTapPosition, t.getRatioTapChangerPosition(), "Ratio tap changer position", 1, TypedValue.TRACE_SEVERITY));
                }
            }
        }
        if (modificationsCount > 0) {
    ...
    private void applyStaticVarCompensatorModification(Network network, Reporter subReporter) {
        ...
        for (VoltageInitStaticVarCompensatorModificationInfos s : voltageInitModificationInfos.getStaticVarCompensators()) {
            ...
            if (staticVarCompensator == null) {
                staticVarsReporter.report(Report.builder().withKey("staticVarCompensatorNotFound")
                ...
                modificationsCount++;
                staticVarsReporter.report(Report.builder().withKey("staticVarCompensatorModification")
                ...
                if (s.getVoltageSetpoint() != null) {
                    ...
                    staticVarsReporter.report(ModificationUtils.buildModificationReport(oldTargetV, s.getVoltageSetpoint(), VOLTAGE_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
                if (s.getReactivePowerSetpoint() != null) {
                    ...
                    staticVarsReporter.report(ModificationUtils.buildModificationReport(oldTargetQ, s.getReactivePowerSetpoint(), REACTIVE_POWER_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
            }
        }
        if (modificationsCount > 0) {
    ...
    private void applyVscConverterStationModification(Network network, Reporter subReporter) {
        ...
        for (VoltageInitVscConverterStationModificationInfos v : voltageInitModificationInfos.getVscConverterStations()) {
            ...
            if (vscConverterStation == null) {
                vscConverterStationsReporter.report(Report.builder().withKey("vscConverterStationNotFound")
                ...
                modificationsCount++;
                vscConverterStationsReporter.report(Report.builder().withKey("vscConverterStationModification")
                ...
                if (v.getVoltageSetpoint() != null) {
                    ...
                    vscConverterStationsReporter.report(ModificationUtils.buildModificationReport(oldTargetV, v.getVoltageSetpoint(), VOLTAGE_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
                if (v.getReactivePowerSetpoint() != null) {
                    ...
                    vscConverterStationsReporter.report(ModificationUtils.buildModificationReport(oldTargetQ, v.getReactivePowerSetpoint(), REACTIVE_POWER_SET_POINT, 1, TypedValue.TRACE_SEVERITY));
                }
            }
        }
        if (modificationsCount > 0) {
    ...
    private void applyShuntCompensatorModification(Network network, Reporter subReporter) {
        ...
        for (VoltageInitShuntCompensatorModificationInfos m : voltageInitModificationInfos.getShuntCompensators()) {
            ...
            if (shuntCompensator == null) {
                shuntCompensatorsReporter.report(Report.builder().withKey("shuntCompensatorNotFound")
                ...
                if (!reports.isEmpty()) {
                    modificationsCount++;
                    shuntCompensatorsReporter.report(Report.builder().withKey("shuntCompensatorModification")

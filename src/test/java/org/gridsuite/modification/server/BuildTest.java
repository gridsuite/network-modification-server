...
public class BuildTest {
    ...
    public void runBuildTest() throws InterruptedException {
        ...
        List<ModificationEntity> entities2 = new ArrayList<>();
        entities2.add(modificationRepository.createGeneratorEntity(NEW_GENERATOR_ID, NEW_GENERATOR_ID, EnergySource.HYDRO, "v2", "1A", 0., 500., 1., 100., 50., true, 225., 8., 20., 50., true, 9F, 35., 25., "terminalId", "LINE", List.of()));

...
public class BuildTest {
    ...
    public void runBuildTest() throws InterruptedException {
        ...
        List<ModificationEntity> entities2 = new ArrayList<>();
        entities2.add(modificationRepository.createGeneratorEntity("newGenerator", "newGenerator", EnergySource.HYDRO, "v2", "1A", 0., 500., 1., 100., 50., true, 225., null, null, null, false, null, null, null, List.of()));

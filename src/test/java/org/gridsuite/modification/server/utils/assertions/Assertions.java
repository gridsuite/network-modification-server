...
public class Assertions extends org.assertj.core.api.Assertions {
    @CheckReturnValue
    public static <T extends ModificationInfos> DTOAssert<ModificationInfos> assertThat(T actual) {
        return new DTOAssert<>(actual);
    }

    @CheckReturnValue
    public static <T extends NetworkModificationResult> DTOAssert<NetworkModificationResult> assertThat(T actual) {
        return new DTOAssert<>(actual);
    }
}

...
public final class TestUtils {
    ...
    public static String getJsonBody(Object data, UUID networkUuid, String variantId) throws JsonProcessingException {
        return createJsonPayload(data, networkUuid, variantId);
    }

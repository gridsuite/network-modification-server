...
public class MatcherTwoWindingsTransformerCreationInfos extends MatcherModificationInfos<TwoWindingsTransformerCreationInfos> {
    public MatcherTwoWindingsTransformerCreationInfos(TwoWindingsTransformerCreationInfos ref) {
        super(ref);
    }

    private static boolean matchesCurrentLimitsInfos(CurrentLimitsInfos cl1, CurrentLimitsInfos cl2) {
    ...
    private static boolean matchesRatioTapChangerInfos(RatioTapChangerCreationInfos rt1, RatioTapChangerCreationInfos rt2) {
    ...
    private static boolean matchesPhaseTapChangerInfos(PhaseTapChangerCreationInfos pt1, PhaseTapChangerCreationInfos pt2) {
    ...
    public boolean matchesSafely(TwoWindingsTransformerCreationInfos m) {
        return super.matchesSafely(m)
                ...
                && m.getVoltageLevelId1().equals(getReference().getVoltageLevelId1())
                && m.getVoltageLevelId2().equals(getReference().getVoltageLevelId2())
                && m.getBusOrBusbarSectionId1().equals(getReference().getBusOrBusbarSectionId1())
                && m.getBusOrBusbarSectionId2().equals(getReference().getBusOrBusbarSectionId2())
                && m.getRatedVoltage1() == getReference().getRatedVoltage1()
                && m.getRatedVoltage2() == getReference().getRatedVoltage2()
                && m.getMagnetizingSusceptance() == getReference().getMagnetizingSusceptance()
                && m.getMagnetizingConductance() == getReference().getMagnetizingConductance()
                ...
                && matchesRatioTapChangerInfos(m.getRatioTapChanger(), getReference().getRatioTapChanger())
                && matchesPhaseTapChangerInfos(m.getPhaseTapChanger(), getReference().getPhaseTapChanger());
    }
}

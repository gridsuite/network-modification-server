...
public class SendInput extends PostServeAction {
    ...
    public void doAction(ServeEvent serveEvent, Admin admin, Parameters parameters) {
        ...
        QueryParameter receiverParam = serveEvent.getRequest().getQueryParams().get(RECEIVER_HEADER);
        if (receiverParam != null) {
            messageBuilder.setHeader(RECEIVER_HEADER, receiverParam.firstValue());
        }

...
public final class TestImpactUtils {
    ...
    public static void testElementImpacts(ObjectMapper mapper, String resultAsString, List<BaseImpact> elementImpactsExpected) throws JsonProcessingException {
        Optional<NetworkModificationResult> networkModificationResult = mapper.readValue(resultAsString, new TypeReference<>() { });
        assertTrue(networkModificationResult.isPresent());
        NetworkModificationResult resultExpected = NetworkModificationResult.builder()
    ...
    private static List<BaseImpact> createBranchImpacts(SimpleImpactType impactType, IdentifiableType branchType, String branchId,
        ...
        LinkedList<BaseImpact> impacts = new LinkedList<>(List.of(createElementImpact(impactType, branchType, branchId, new HashSet<>(List.of(substationId1, substationId2)))));

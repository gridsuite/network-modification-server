...
public class ModificationRepositoryTest {
    ...
    public void testLineCreation() {
        var createLineEntity1 = LineCreationInfos.builder()
            .id("idLine1")
            .name("nameLine1")
            .r(1.0)
            .x(1.1)
            .shuntConductance1(10.0)
            .shuntSusceptance1(11.0)
            .shuntConductance2(100.0)
            .shuntSusceptance2(100.1)
            .voltageLevelId1("vlId11")
            .busOrBusbarSectionId1("busId11")
            .voltageLevelId2("vlId12")
            .busOrBusbarSectionId2("busId12")
            ...
            .position2(ConnectablePositionInfos.builder()
                ...
                .direction(Direction.TOP).build())
            .build().toEntity();
        var createLineEntity2 = LineCreationInfos.builder()
            .id("idLine2")
            .name("nameLine2")
            .r(2.0)
            .x(2.2)
            .shuntConductance1(20.0)
            .shuntSusceptance1(22.0)
            .shuntConductance2(200.0)
            .shuntSusceptance2(200.2)
            .voltageLevelId1("vlId21")
            .busOrBusbarSectionId1("busId21")
            .voltageLevelId2("vlId22")
            .busOrBusbarSectionId2("busId22")
            ...
            .position2(ConnectablePositionInfos.builder()
                .label("cn44")
                .direction(Direction.BOTTOM).build())
            .currentLimits2(CurrentLimitsInfos.builder()
                .permanentLimit(5.0)
                .build())
            .build().toEntity();
        var createLineEntity3 = LineCreationInfos.builder()
            .id("idLine3")
            .name("nameLine3")
            .r(3.0)
            .x(3.3)
            .shuntConductance1(30.0)
            .shuntSusceptance1(33.0)
            .shuntConductance2(300.0)
            .shuntSusceptance2(300.3)
            .voltageLevelId1("vlId31")
            .busOrBusbarSectionId1("busId31")
            .voltageLevelId2("vlId32")
            .busOrBusbarSectionId2("busId32")
            .position1(ConnectablePositionInfos.builder()
                .label("cn55")
                .direction(Direction.TOP).build())
            .position2(ConnectablePositionInfos.builder()
            ...
            .currentLimits1(CurrentLimitsInfos.builder()
                ...
                .build())
            .build().toEntity();
        var createLineEntity4 = LineCreationInfos.builder()
            .id("idLine4")
            .name("nameLine4")
            .r(3.0)
            .x(3.3)
            ...
            .voltageLevelId1("vlId41")
            .busOrBusbarSectionId1("busId41")
            .voltageLevelId2("vlId42")
            .busOrBusbarSectionId2("busId42")
            .position1(ConnectablePositionInfos.builder()
                .label("cn77")
                .direction(Direction.TOP).build())
            .position2(ConnectablePositionInfos.builder()
                .label("cn88")
                .direction(ConnectablePosition.Direction.BOTTOM).build())
            .currentLimits1(CurrentLimitsInfos.builder()
                .permanentLimit(5.0)
                .build())
            .currentLimits2(CurrentLimitsInfos.builder()

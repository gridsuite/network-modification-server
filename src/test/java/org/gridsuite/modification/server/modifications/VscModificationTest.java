...
class VscModificationTest extends AbstractNetworkModificationTest {
    ...
    private static ConverterStationModificationInfos buildConverterStationWithReactiveCapabilityCurve() {
        return ConverterStationModificationInfos.builder()
                ...
                .reactiveCapabilityCurvePoints(List.of(
                        new ReactiveCapabilityCurveCreationInfos(0.4, 11., 0.7),
                        new ReactiveCapabilityCurveCreationInfos(0.6, 12., 0.8)))
                .build();
    }
    ...
    protected void assertAfterNetworkModificationCreation() {
...

        {
            ...
            List<ReactiveCapabilityCurveCreationInfos> modificationPoints = vscModificationInfos.getConverterStation1().getReactiveCapabilityCurvePoints();

...
import static org.gridsuite.modification.server.NetworkModificationException.Type.OPERATING_ACTION_ERROR;
...
@Tag("IntegrationTest")
public class OperatingStatusModificationEnergiseSideOneLineTest extends AbstractNetworkModificationTest {
    ...
    public void testCreateWithErrors() throws Exception {
        ...
        assertLogMessage(new NetworkModificationException(OPERATING_ACTION_ERROR, "Unable to energise equipment end").getMessage(),

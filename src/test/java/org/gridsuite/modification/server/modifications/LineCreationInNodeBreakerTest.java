...
class LineCreationInNodeBreakerTest extends AbstractNetworkModificationTest {
    ...
    void testCreateLineWithBothCurrentLimits() throws Exception {
        ...
        assertEquals(
            "LineCreationInfos(super=BranchCreationInfos(super=EquipmentCreationInfos(super=EquipmentModificationInfos(super=ModificationInfos(uuid=null, type=LINE_CREATION, date=null, "
                    + "stashed=false, messageType=null, messageValues=null, activated=true, description=null), equipmentId=idLineEdited, properties=null), equipmentName=nameLineEdited), r=110.0, "
                            + "x=110.0, voltageLevelId1=v2, voltageLevelId2=v1, busOrBusbarSectionId1=1A, busOrBusbarSectionId2=1.1, operationalLimitsGroups=[OperationalLimitsGroupInfos(id=null, "
                                    + "currentLimits=CurrentLimitsInfos(permanentLimit=200.0, temporaryLimits=[CurrentTemporaryLimitCreationInfos(name=IT10, value=200.0, "
                                            + "acceptableDuration=600)]), applicability=SIDE1, limitsProperties=null), OperationalLimitsGroupInfos(id=null, "
                                                    + "currentLimits=CurrentLimitsInfos(permanentLimit=100.0, temporaryLimits=[CurrentTemporaryLimitCreationInfos(name=IT20, value=600.0, "
                                                            + "acceptableDuration=1200)]), applicability=SIDE2, limitsProperties=null)], selectedOperationalLimitsGroupId1=null, "
                                                                    + "selectedOperationalLimitsGroupId2=null, connectionName1=cn1LineEdited, connectionDirection1=BOTTOM, "
                                                                            + "connectionName2=cn2LineEdited, connectionDirection2=TOP, connectionPosition1=0, connectionPosition2=0, "
                                                                                    + "connected1=true, connected2=false), g1=15.0, b1=15.0, g2=25.0, b2=25.0, lineSegments=null)",

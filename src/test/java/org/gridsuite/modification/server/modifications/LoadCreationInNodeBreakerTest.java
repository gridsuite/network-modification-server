...
class LoadCreationInNodeBreakerTest extends AbstractNetworkModificationTest {
    ...
    void testCreateWithErrors() throws Exception {
        ...
        String loadCreationInfosJson1 = mapper.writeValueAsString(org.springframework.data.util.Pair.of(loadCreationInfos1, List.of(buildApplicationContext())));
        ...
        String loadCreationInfosJson = mapper.writeValueAsString(org.springframework.data.util.Pair.of(loadCreationInfos, List.of(buildApplicationContext())));
        ...
        loadCreationInfosJson = mapper.writeValueAsString(org.springframework.data.util.Pair.of(loadCreationInfos, List.of(buildApplicationContext())));
        mockMvc.perform(post(getNetworkModificationUri()).content(loadCreationInfosJson).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        ...
        loadCreationInfosJson = mapper.writeValueAsString(org.springframework.data.util.Pair.of(loadCreationInfos, List.of(buildApplicationContext("variant_not_existing"))));

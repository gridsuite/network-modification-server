...
public class GenerationDispatchTest extends AbstractNetworkModificationTest {
    ...
    public void testGenerationDispatchGeneratorsWithFixedSupply() throws Exception {
        ...
        assertLogMessage("Generators without outage simulation: Cannot find generator notFoundGen1 in filter filter3", "generatorNotFound0generatorsWithoutOutage", reportService);
        assertLogMessage("Generators without outage simulation: Cannot find generator notFoundGen2 in filter filter3", "generatorNotFound1generatorsWithoutOutage", reportService);
        ...
        assertLogMessage("Generators with fixed active power: Cannot find generator notFoundGen1 in filter filter1", "generatorNotFound0generatorsWithFixedSupply", reportService);

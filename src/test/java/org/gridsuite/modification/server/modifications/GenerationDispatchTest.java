...
public class GenerationDispatchTest extends AbstractNetworkModificationTest {
    ...
    public void testGenerationDispatch() throws Exception {
        ...
        assertLogMessage("Sum of generator active power setpoints in NORTH region: 150.0 MW.", "SumGeneratorActivePowerNORTH" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in SOUTH region: 50.0 MW.", "SumGeneratorActivePowerSOUTH" + secondSynchronousComponentNum, reportService);
    }
    ...
    public void testGenerationDispatchGeneratorsWithFixedSupply() throws Exception {
        ...
        assertLogMessage("The total amount of supply to be dispatched is : 330.0 MW", "TotalAmountSupplyToBeDispatched" + secondSynchronousComponentNum, reportService);
        assertLogMessage("The supply-demand balance could be met", "SupplyDemandBalanceCouldBeMet" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in EAST region: 5.0 MW.", "SumGeneratorActivePowerEAST" + secondSynchronousComponentNum, reportService);
    ...
    public void testGenerationDispatchWithFrequencyReserve() throws Exception {
        ...
        assertLogMessage("The total amount of supply to be dispatched is : 330.0 MW", "TotalAmountSupplyToBeDispatched" + secondSynchronousComponentNum, reportService);
        assertLogMessage("The supply-demand balance could be met", "SupplyDemandBalanceCouldBeMet" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in WEST region: 145.5 MW.", "SumGeneratorActivePowerWEST" + secondSynchronousComponentNum, reportService);
    ...
    public void testGenerationDispatchWithMaxValueLessThanMinP() throws Exception {
        ...
        assertLogMessage("The supply-demand balance could be met", "SupplyDemandBalanceCouldBeMet" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in NORTH region: 146.0 MW.", "SumGeneratorActivePowerNORTH" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in SOUTH region: 40.375 MW.", "SumGeneratorActivePowerSOUTH" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in EAST region: 7.0 MW.", "SumGeneratorActivePowerEAST" + secondSynchronousComponentNum, reportService);
        assertLogMessage("Sum of generator active power setpoints in WEST region: 5.0 MW.", "SumGeneratorActivePowerWEST" + secondSynchronousComponentNum, reportService);

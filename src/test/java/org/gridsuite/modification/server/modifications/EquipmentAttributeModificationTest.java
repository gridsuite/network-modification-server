...
class EquipmentAttributeModificationTest extends AbstractNetworkModificationTest {
    ...
    void testEquipmentAttributeModificationInfos() throws Exception {
        ...
        EquipmentAttributeModificationInfos modificationInfos = EquipmentAttributeModificationInfos.builder()
            ...
            .build();
        assertEquals(String.format("EquipmentAttributeModificationInfos(super=EquipmentAttributeModificationModel(super=EquipmentModificationModel(super=ModificationModel(type=EQUIPMENT_ATTRIBUTE_MODIFICATION), equipmentId=equipmentId, properties=null), equipmentAttributeName=equipmentAttributeName, equipmentAttributeValue=equipmentAttributeValue, equipmentType=VOLTAGE_LEVEL), uuid=%s, date=2021-02-19T00:00:00Z, stashed=false, messageType=null, messageValues=null, activated=null, description=null)", modificationUuid), modificationInfos.toString());
